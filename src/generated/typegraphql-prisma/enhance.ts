...
const modelsInfo = {
  User: ["email", "id", "name"],
  Post: ["authorId", "content", "id", "published", "title"]
};
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "email", "id", "name", "posts"],
  UserOrderByInput: ["email", "id", "name"],
  UserWhereUniqueInput: ["email", "id"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "email", "id", "name"],
  PostWhereInput: ["AND", "OR", "NOT", "authorId", "content", "id", "published", "title", "author"],
  PostOrderByInput: ["authorId", "content", "id", "published", "title"],
  PostWhereUniqueInput: ["id"],
  PostScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "authorId", "content", "id", "published", "title"],
  UserCreateInput: ["email", "name", "posts"],
  UserUpdateInput: ["email", "name", "posts"],
  UserUpdateManyMutationInput: ["email", "name"],
  PostCreateInput: ["content", "published", "title", "author"],
  PostUpdateInput: ["content", "published", "title", "author"],
  PostUpdateManyMutationInput: ["content", "published", "title"],
  ...
  PostCreateWithoutAuthorInput: ["content", "published", "title"],
  PostCreateOrConnectWithoutAuthorInput: ["where", "create"],
  PostUpsertWithWhereUniqueWithoutAuthorInput: ["where", "update", "create"],
  PostUpdateWithWhereUniqueWithoutAuthorInput: ["where", "data"],
  PostUpdateManyWithWhereWithoutAuthorInput: ["where", "data"],
  PostScalarWhereInput: ["AND", "OR", "NOT", "authorId", "content", "id", "published", "title"],
  ...
  PostUpdateWithoutAuthorInput: ["content", "published", "title"]
};
const outputsInfo = {
  AggregateUser: ["_count", "_avg", "_sum", "_min", "_max"],
  UserGroupBy: ["email", "id", "name", "_count", "_avg", "_sum", "_min", "_max"],
  AggregatePost: ["_count", "_avg", "_sum", "_min", "_max"],
  PostGroupBy: ["authorId", "content", "id", "published", "title", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  UserCountAggregate: ["email", "id", "name", "_all"],
  UserAvgAggregate: ["id"],
  UserSumAggregate: ["id"],
  UserMinAggregate: ["email", "id", "name"],
  UserMaxAggregate: ["email", "id", "name"],
  PostCountAggregate: ["authorId", "content", "id", "published", "title", "_all"],
  PostAvgAggregate: ["authorId", "id"],
  PostSumAggregate: ["authorId", "id"],
  PostMinAggregate: ["authorId", "content", "id", "published", "title"],
  PostMaxAggregate: ["authorId", "content", "id", "published", "title"]
};
const argsInfo = {
